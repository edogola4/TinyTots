...
const Cart = () => {
  ...
  const EmptyCart = () => {
    return (
      <div className="container personalized-empty-cart">
        <div className="row">
          <div className="col-md-12 py-5 bg-light text-center">
            <h4 className="p-3 display-5">Your cart is feeling lonely!</h4>
            <p className="lead">Add some items to brighten up your day.</p>
  ...
  const ShowCart = () => {
    ...
    return (
      <section className="h-100 gradient-custom personalized-cart-section">
        <div className="container py-5">
          {/* Personalised greeting if user information exists */}
          {user && user.name && (
            <div className="text-end mb-3">
              <h5 className="text-muted">Hello, {user.name}! Here's your cart:</h5>
            </div>
          )}
  ...
  return (
    <>
      <Navbar />
      <div className="container my-3 py-3 personalized-cart-container">
